                ...
                <table class="table-responsive text-center" id="basic-1">
                    <thead>
                        <tr>
                            <th>Owner</th>
                            <th>RB ID No.</th>
                            <th>RB Active Date</th>
                            <th>Re-Ignite Bonus</th>
                    ...
                    <tbody>
                        @if(isset($data['rebirth_members']) && count($data['rebirth_members']) > 0)
                            @foreach($data['rebirth_members'] as $member)
                            <tr>
                                <td>
                                ...
                                <td>₹ {{ number_format($member->re_ignite_bonus, 2) }}<br><small>For {{ $member->rb_id }}</small></td>
                        ...
                        @else
                            <tr>
                                <td colspan="9" class="text-center">No rebirth members found</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
