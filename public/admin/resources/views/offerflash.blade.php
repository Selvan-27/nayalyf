...
<div class="page-body">
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <a href="#" class="btn btn-primary mt-md-0 mt-2">Set Flash Sale</a>
        </div>
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body vendor-table">
                <h3 class="text-center" style="color: #ff0000">Flash Sale Offer Report</h3>
                <table class="table-responsive text-center" id="basic-1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href=""><i class="fa fa-eye me-2 font-success"></i></a>
                                    <a href=""><i class="fa fa-edit font-primary"></i></a>
                                </div>
                            </td>
