...
<div class="page-body">
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body vendor-table">
                ...
                <!--<table class="table-responsive text-center" id="basic">-->
                <!--    <thead>-->
                <!--        <tr>-->
                <!--            <th>Date</th>-->
                <!--            <th> Member</th>-->
    ...
    <tbody>
        @foreach($reportData as $row)
            <tr>
                <td>{{ $row->Date }}</td>
                <td>{{ $row->Member }} {{$row->memberid}}</td>
                @foreach($products as $product)
                    <td>{{ $row->{'product' . $product->id . '_qty'} }}/<b>{{ $row->{'product' . $product->id . '_qty'}*$row->{'product' . $product->id . '_price'} }}</b></td>
