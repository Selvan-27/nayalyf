                        ...
                        <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="b1-tab" data-bs-toggle="tab" href="#top-b1" role="tab"
                                    aria-controls="top-b1" aria-selected="true">Global Board 1
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="b2-tab" data-bs-toggle="tab" href="#top-b2" role="tab"
                                    aria-controls="top-b2" aria-selected="false">Global Board 2
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="b3-tab" data-bs-toggle="tab" href="#top-b3" role="tab"
                                    aria-controls="top-b3" aria-selected="false">Global Board 3
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="b4-tab" data-bs-toggle="tab" href="#top-b4" role="tab"
                                    aria-controls="top-b4" aria-selected="false">Global Board 4
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="b5-tab" data-bs-toggle="tab" href="#top-b5" role="tab"
                                    aria-controls="top-b5" aria-selected="false">Global Board 5
                                </a>
                            </li>
                        ...
                        <div class="tab-content" id="top-tabContent">
                            @for ($i = 1; $i <= 5; $i++)
                                <div class="tab-pane fade{{ $i == 1 ? ' show active' : '' }}" id="top-b{{ $i }}" role="tabpanel" aria-labelledby="b{{ $i }}-tab">
                                    <h5 class="f-w-600">Global Board {{ $i }}</h5>
                                    <div class="card-body vendor-table">
                                        <table class="table table-responsive text-center">
                                            @php
                                                if (!function_exists('renderGlobalTreeRow')) {
                                                    function renderGlobalTreeRow($tree, $level = 0, $parentTreeNo = 1) {
...
<style>
/* Custom CSS for Global Tree Alignment */
.vendor-table .table {
    width: 100%;
    table-layout: fixed;
    margin: 0 auto;
...
document.getElementById('treeForm').addEventListener('submit', function (e) {
    ...
    if(root && root_no){
        ...
        window.location.href = `/global_tree?root_${root_no}=${encodeURIComponent(root)}`;
    }
});
</script>
@stop