            ...
            <div class="row g-3">
                ...
                <div class="col-6">
                    <a href="/Ignite_Bonus"><div class="product-box" style="background-color: #0d3ff5;">
                        <div class="product-content">
                            <h5 style="color: #fff;">Ignite Bonus</h5><br>
                ...
                <div class="col-6">
                    <a href="/Re-Ignite_Bonus"><div class="product-box" style="background-color: #0d3ff5;">
                        <div class="product-content">
                            <h5 style="color: #fff;">Re-Ignite Bonus</h5><br>
                            <div class="bottom-content">
                                <h4 style="color: #fff;">₹ {{ $reignite_payout ?? 0 }}</h4>
                            </div>
                        </div>
                    </div></a>
                </div>
                ...
                <div class="col-6">
                    <a href="/Global_Bonus"><div class="product-box" style="background-color: #0d3ff5;">
                        <div class="product-content">
                            <h5 style="color: #fff;">Global Bonus</h5><br>
                            <div class="bottom-content">
                ...
                <div class="col-6">
                    <a href="/Fast_Track_Bonus"><div class="product-box" style="background-color: #0d3ff5;">
                        <div class="product-content">
                            <h5 style="color: #fff;">Fast Track Bonus</h5><br>
                            <div class="bottom-content">
                ...
                <div class="col-6">
                    <a href="/Achievement_Bonus"><div class="product-box" style="background-color: #0d3ff5;">
                        <div class="product-content">
                            <h5 style="color: #fff;">Achievement Bonus</h5><br>
                            <div class="bottom-content">
                ...
                <div class="col-6">
                    <a href="/Sales_Incentive"><div class="product-box" style="background-color: #0d3ff5;">
                        <div class="product-content">
                            <h5 style="color: #fff;">Sales<br>Incentive</h5>
                            <div class="bottom-content">
