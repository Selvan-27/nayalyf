            ...
            <div class="card">
                <div class="card-body">
                    <div class="table table-responsive ">
                        ...
                        <a href="/shop" class="btn btn-primary w-100">+ Add More Products</a>
...
let dc_cost = cartTotal.dc_cost || 0;
let productTotal   = cartTotal.total_price || 0;


 productTotal = productTotal + dc_cost;
    ...
    //  let cartTotal = JSON.parse(localStorage.getItem("Ecart_total"));
            ...
            if (cartTotal) {
                ...
                document.getElementById('use-wallet').innerText = `-₹ ${(cartTotal.wallet || 0).toFixed(2)}`;
                 document.getElementById('delivery-charge').innerText =  `₹ ${(cartTotal.dc_cost || 0).toFixed(2)}`;
...
//               Swal.fire({
//                         icon: 'error',
//                         title: 'minimum Order value Rs.250!',
//                         // text: "You have select Delivery Address.",
//                         confirmButtonText: 'OK'
//               }).then(() => {
//                          window.location.href = "/UC_Shop";
...
//             }
    ...
    if (selected==0) {
     ...
     let grand_total= cartTotal.grand_total; 
      ...
      let delivery_charge= cartTotal.dc_cost; 
