    ...
    <section class="pt-0">
        <div class="profile-wrapper">
            ...
            <ul class="account-listing">
                ...
                <li>
                    <a href="/Banking_Edit" class="account-link">
                ...
                <li>
                    <a href="/Affiliate_Terms" class="account-link">
                ...
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="row gx-3 align-items-center mb-3">
                                <div class="col">Signed On<br>{{$user->created_at->format('d M Y')}}</div>
                                <div class="col">Active From<br>{{$active_date}}</div>
                            </div>
                            <hr>
                            <div class="row gx-3 align-items-center mb-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="/UC_Shop_id_card" class="btn theme-btn p-2">Apply For New ID Card</a>
                    @else
