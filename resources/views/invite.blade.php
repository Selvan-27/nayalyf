        ...
        <div class="custom-container">
            <div class="row g-3">
                ...
                <div class="col-12">
                    <div class="product-box" style="background-color: #0d3ff5;">
                        <div class="product-content">
                            <h5 style="color: #fff;">Affiliate Incentive</h5>
                            <div class="bottom-content">
                                <h4 style="color: #fff;">📈 {{ number_format($ignite_payout ?? 0) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12">
                    <div class="product-box" style="background-color: #0d3ff5;">
                        <div class="product-content">
                            ...
                            <div class="bottom-content">
                                <h4 style="color: #fff;">💹 {{ $unique_incentive_income ?? 0 }}</h4>
                                <a href="/Sales_Incentive" class="btn btn-small btn-info shop-btn see-all">View</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12">
                    <div class="product-box" style="background-color: #ffe00b;">
                        <div class="product-content">
                            <h4 style="color: #000;">Your Earnings</h4>
                            <div class="bottom-content text-center">
                                <h2 style="color: #000;">💳 {{ $ignite_payout+$unique_incentive_income ?? 0 }}</h2>
                                <a href="/Upgrade" class="btn btn-small btn-dark shop-btn see-all">Redeem</a>
                            </div>
