...
<body>
                    ...
                    <div class="product-box" style="background-color: #0d3ff5;">
                        <div class="product-content">
                            ...
                            <div class="bottom-content">
                                <h5 style="color: #fff;">{{$totalContacts}}</h5>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="/scheduled">
                    <div class="product-box" style="background-color: #ffe00b;">
                        <div class="product-content">
                            ...
                            <div class="bottom-content">
                                <h5 style="color: #000;">{{$scheduledCalls}}</h5>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <li class="w-100 address-box">
                    ...
                    <div class="card address-card" >
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                   <span>{{ $index + 1 }}</span>
                                <h4 class="fw-bold theme-color">{{ $contact->name }}</h4>
                                <h6 class="fw-bold title-color">{{ $contact->phone_number }}</h6>
                            </div>
                            <div>
                            <a href="{{ route('contacts.log', $contact->id) }}" class="theme-color fw-medium" 
    ...
    <div class="offcanvas offcanvas-bottom filter-offcanvas" tabindex="-1" id="new-address">
        <div class="offcanvas-header">
          ...
          <form action="{{ route('contacts.store') }}" method="POST" class="theme-form">
        <div class="offcanvas-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control wo-icon"  name="name" placeholder="Enter Name">
                </div>

                <div class="form-group">
                    <label class="form-label" for="inputcontactnumber">Mobile</label>
                    <input type="text" class="form-control wo-icon"  name="phone_number" id="inputcontactnumber" placeholder="Enter Mobile Number">
                </div>
                
           
        </div>
        <div class="btn-grp d-flex gap-3 mt-4">
             <button type="submit" class="btn theme-btn w-50">Save</button>
            <a data-bs-dismiss="offcanvas" class="btn theme-btn w-50">Close</a>
        </div>
